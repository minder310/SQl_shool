...
<ul class="list-group col-md-10 m-auto">
    ...
    <li class="d-flex list-group-item list-group-item-light list-group-item-action">
        ...
        <div class="col-3 text-center">
            <a href="./api/survey_active.php?id=<?=$surver['id']?>" class="btn btn-sm btn-secondary mx-1">啟用</a>
            <a href="admin_center.php?do=survey_edit&id=<?=$surver['id']?>" class="btn btn-sm btn-success mx-1">編輯</a>
            <a href="./api/survey_del.php?id=<?=$surver['id']?>" class="btn btn-sm btn-info mx-1">刪除</a>
        </div>
    </li>
<?php
}
