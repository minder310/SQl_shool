...
if(isset($_GET['id'])){
    ...
    // dd($subject);
    $options=all('survey_option',['subject_id'=>$_GET['id']]);
    ...
    <div class="form-group row col-12">
        ...
        ?>
           ...
           <label class="col-2 text-right">項目<?=$idx+1;?></label>
            <input type="text" class="form-control col-10" name='opt[]' value="<?=$option['opt'];?>" class="form-control col-10">
